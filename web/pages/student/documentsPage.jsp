...
<body>
    <div class="container">
        ...
        <div class="lead">
            <div class="text-center">
                <h1>
                    <strong id="docHeader">Заявление на заселение</strong>
                </h1>
                <hr class="colorgraph">
            </div>
            ...
            <form class="form-horizontal" action="/Action/StudentDocuments" method="post">
                <div id="docStatement">
                    ...
                    <div class="text-center">
                        <input type="button" id="docNext" value="Далее" class="btn btn-primary btn-lg">
                    </div>
                </div>
                <div id="docContract" hidden>
                    <div class ="col-lg-8 col-lg-offset-2">
                        <div class="form-group">
                            <div class="col-xs-3">Факультет </div>
                            <div class="col-xs-9">
                                <input type="text" name="faculty" id="faculty" required class="form-control input-lg" placeholder="Полная расшифровка" tabindex="17">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-3">Кафедра </div>
                            <div class="col-xs-9">
                                <input type="text" name="chair" id="chair" required class="form-control input-lg" placeholder="Полная расшифровка" tabindex="18">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-3">Серия паспорта </div>
                            <div class="col-xs-9">
                                <input type="text" name="passportSeries" id="passportSeries" required class="form-control input-lg" placeholder="XX" tabindex="19">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-3">Номер паспорта </div>
                            <div class="col-xs-9">
                                <input type="text" name="passportNumber" id="passportNumber" required class="form-control input-lg" placeholder="XXXXXXX" tabindex="20">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-3">Дата выдачи паспорта </div>
                            <div class="col-xs-9">
                                <input type="text" name="passportDateOfIssue" id="passportDateOfIssue" required class="form-control input-lg" placeholder="дд.мм.гггг" tabindex="21">
                            </div>
                        </div>
                    </div>

                    <div class="text-center">
                        <input type="submit" id="apply" value="Подать документы" class="btn btn-primary btn-lg">
                    </div>
                </div>
            </form>
        </div>
    ...
    <script type="text/javascript" src="/Scripts/studentDocumentsUtils.js"></script>
